...
const getGenderType = (digit) => {
  if (digit) {
    if (digit.toString() === '1') return MALE_GENDER_TYPES;
    if (digit.toString() === '2') return FEMALE_GENDER_TYPES;
    if (digit.toString() === '3') return OTHERS_GENDER_TYPES;
    return OTHERS_GENDER_TYPE;
  }
  return '';
};

export { getGender, getGenderType };
