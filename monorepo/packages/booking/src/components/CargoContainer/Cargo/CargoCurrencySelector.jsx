...
const CargoCurrencySelector = ({ items }) => {
  const {
    state: { currency, payWith },
    dispatch,
  } = useCargo();
  ...
  const onSelectCurrency = (item) => {
    ...
    dispatch({
      type: cargoFormActions.CHANGE_FORM_ITEM,
...
CargoCurrencySelector.propTypes = {
...
export default CargoCurrencySelector;
