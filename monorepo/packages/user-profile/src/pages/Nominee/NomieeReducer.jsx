...
import { isNomineeValid, isDuplicateNominee, getUpdatedNominees } from './nomineeUtils';
...
export const nomineeReducer = (state, action) => {
  ...
  switch (type) {
    ...
    case nomieeActions.UPDATE_FORM: {
      ...
      const duplicateNominee = isDuplicateNominee(nomineeNewValue, nominees, index);

      const nominee = new Nominee({
        ...nomineeNewValue,
        ...duplicateNominee,
        ...isNomineeValid(nomineeNewValue, duplicateNominee?.duplicateNominee),
      });
      ...
      const updatedNomineesList = getUpdatedNominees(updatedNominees);
