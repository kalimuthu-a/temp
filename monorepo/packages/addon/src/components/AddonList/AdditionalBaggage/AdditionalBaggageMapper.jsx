...
import { AdditionalBaggage } from './index';
import { categoryCodes } from '../../../constants/index';
import { addonCanRemove } from '../../../functions/utils';

const { abhf } = categoryCodes;

const ComponentMapper = {
  [abhf]: {
    Component: AdditionalBaggage,
    className: 'additional-piece-addon',
  },
};

const AdditionalBaggageMapper = (props) => {
...
AdditionalBaggageMapper.propTypes = {
...
export default AdditionalBaggageMapper;
